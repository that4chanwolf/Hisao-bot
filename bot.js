...
app.post('/', function(req, res) {
	...
	Object.keys(client.chans).forEach(function(channel) {
		client.say(channel, irc.colors.codes.light_gray + payload.repository.name + (typeof payload.repository.language === "undefined" ? "" : "(" + irc.colors.codes.light_blue + payload.repository.language + irc.colors.reset + ")" ) +irc.colors.codes.reset + " had " + payload.commits.length + " commit" + ( payload.commits.length > 1 ? "s" : "" ) + " added.");
